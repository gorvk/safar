...
create policy "dev-policy jh40r1_0"
on "storage"."objects"
as permissive
for select
to public
...
create policy "dev-policy jh40r1_1"
on "storage"."objects"
as permissive
for insert
to authenticated
...
create policy "dev-policy jh40r1_2"
on "storage"."objects"
as permissive
for update
to authenticated
...
create policy "dev-policy jh40r1_3"
on "storage"."objects"
as permissive
for delete
to authenticated
...
create policy "dev-policy t4unay_0"
on "storage"."objects"
as permissive
for select
to public
using ((bucket_id = 'itinerary-images'::text));


create policy "dev-policy t4unay_1"
on "storage"."objects"
as permissive
for insert
to authenticated
with check ((bucket_id = 'itinerary-images'::text));


create policy "dev-policy t4unay_2"
on "storage"."objects"
as permissive
for update
to authenticated
...
create policy "dev-policy t4unay_3"
on "storage"."objects"
as permissive
for delete
to authenticated
