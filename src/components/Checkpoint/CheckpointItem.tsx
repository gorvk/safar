...
export const CheckpointItem = (props: { data: TCheckpoint, itineraryId: string, checkpointId: number }) => {
  ...
  return (
    <li>
      ...
      <div onClick={() => navigate(`/detail/${itineraryId}/${checkpointId}`, { state: { data } })} className="my-1 bg-teal-600 py-2 px-3 rounded-lg text-white font-medium flex justify-between cursor-pointer">
